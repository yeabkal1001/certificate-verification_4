      ...
      >
        <Card className="border-2 shadow-lg">
          <CardHeader className="text-center">
            <div className="mx-auto bg-gradient-to-r from-orange-500 to-red-600 p-3 rounded-full w-fit mb-4">
              <Shield className="h-6 w-6 text-white" />
            </div>
            <CardTitle className="text-2xl">Admin Registration</CardTitle>
            <CardDescription>Create a new administrator account for IMS Certify</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="mb-4 p-3 bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded-lg">
              <p className="text-sm text-orange-800 dark:text-orange-200">
                <strong>Restricted Access:</strong> This page is for creating administrator accounts only. A valid admin
