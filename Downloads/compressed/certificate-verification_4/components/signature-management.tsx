...
export function SignatureManagement() {
  ...
  const [signaturePosition, setSignaturePosition] = useState({ x: 120, y: 80 })
              ...
              <TabsContent value="draw" className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    data-testid="signature-title-input"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4">
                    ...
                    <div className="flex justify-between mt-2">
                      ...
                      <Button variant="outline" size="sm" onClick={clearCanvas} data-testid="clear-canvas-button">
                        Clear
                      </Button>
                    </div>
                  </div>
                ...
                <Button onClick={saveSignature} className="w-full" data-testid="save-signature-button">
              ...
              <TabsContent value="upload" className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={signatureName}
                    onChange={(e) => setSignatureName(e.target.value)}
                    data-testid="uploaded-signature-name-input"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    data-testid="upload-signature-area"
                  >
                    <Upload className="h-8 w-8 mx-auto mb-2 text-gray-400" />
                    <p className="text-sm text-gray-600 mb-2">Click to upload or drag and drop</p>
                    <p className="text-xs text-gray-500 mb-4">PNG, JPG up to 5MB</p>
                    <Button variant="outline" className="cursor-pointer" data-testid="choose-file-button">
                      Choose File
                    </Button>
                    <input
                      ref={fileInputRef}
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        data-testid={`preview-signature-button-${signature.id}`}
                      >
                      ...
                      {!signature.isActive && (
                        <Button
                          ...
                          data-testid={`set-active-signature-button-${signature.id}`}
                        >
                          Set Active
                        </Button>
                      )}
                      <Button
                        ...
                        data-testid={`delete-signature-button-${signature.id}`}
                      >
          ...
          {previewSignature && (
            <div className="space-y-4">
                    ...
                    <div className="text-center">
                      <div className="h-16 w-40 mb-1 flex items-center justify-center">
                        <Draggable
                          ...
                          bounds="parent"
                          onStop={(e, d) => setSignaturePosition({ x: d.x, y: d.y })}
                        >
              ...
              <div className="flex justify-end gap-4">
                <Button variant="outline" data-testid="download-preview-button">
                  <Download className="h-4 w-4 mr-2" />
                  Download Preview
                </Button>
                <Button onClick={() => setActiveSignature(previewSignature.id)} data-testid="set-active-signature-preview-button">
